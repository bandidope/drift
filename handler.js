...
global.dfail = (type, m, conn, usedPrefix) => {
    let msg = {
        rowner: " | 𝗦𝘁𝘆𝗹𝗲 𝗗𝗿𝗶𝗳𝘁 | `Sorry Solo Mi Creador LO Puede Usar ⚡`",
        owner: " | 𝗦𝘁𝘆𝗹𝗲 𝗗𝗿𝗶𝗳𝘁 |`Perdon Solo Los Creadores De Style Lo Usan ⚡.`",
        mods: " | 𝗦𝘁𝘆𝗹𝗲 𝗗𝗿𝗶𝗳𝘁 | `Lo Siento Solo El Staff Lo Puede Usar⚡`",
        premium: " | 𝗦𝘁𝘆𝗹𝗲 𝗗𝗿𝗶𝗳𝘁 | `No Eres Premium En Mi Servidor ⚡`",
        group: " | 𝗦𝘁𝘆𝗹𝗲 𝗗𝗿𝗶𝗳𝘁 |  `Comando Solo Para Grupos ⚡`",
        private: " | 𝗦𝘁𝘆𝗹𝗲 𝗗𝗿𝗶𝗳𝘁 |  `Debes Usar El Chat Privado ⚡`",
        admin: " | 𝗦𝘁𝘆𝗹𝗲 𝗗𝗿𝗶𝗳𝘁 | `Tu No Eres Administrador ⚡`",
        botAdmin: "  | 𝗦𝘁𝘆𝗹𝗲 𝗗𝗿𝗶𝗳𝘁 | `Debes Darme Admin Primero ⚡`",
        unreg: " | 𝗦𝘁𝘆𝗹𝗲 𝗗𝗿𝗶𝗳𝘁 | `Debes Registrate Primero ⚡`\n\n`Para Registrarse:`\n\n> .reg nombre.edad\n\n`Ejemplo:`\n\n> .reg Style.18",
        restrict: " | 𝗦𝘁𝘆𝗹𝗲 𝗗𝗿𝗶𝗳𝘁 | `Debes Registrate Primero ⚡`" 
    }[type]
